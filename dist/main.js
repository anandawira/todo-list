...
const DomController = (() => {
  ...
  const createTodoItem = (todo, todoId, projectId) => {
    ...
    editIcon.addEventListener("click", () => {
      ...
      const dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.default)(new Date(todo.dueDate), "yyyy-MM-dd");
      ...
      const editFunction = () => {
        ...
        _ProjectController__WEBPACK_IMPORTED_MODULE_0__.default.editTodo(projectId, todoId, todo);
  ...
  const createCardFooter = (projectId) => {
    ...
    dom.addEventListener("click", () => {
      sweetalert__WEBPACK_IMPORTED_MODULE_1___default()({
        ...
        if (willDelete) {
          _ProjectController__WEBPACK_IMPORTED_MODULE_0__.default.removeProject(projectId);
          dom.parentElement.remove();
          sweetalert__WEBPACK_IMPORTED_MODULE_1___default()("Poof! Your project has been deleted!", {
            icon: "success",
          });
        } else {
          sweetalert__WEBPACK_IMPORTED_MODULE_1___default()("Your project is safe!");
        }
      });
    });
...
_DomController__WEBPACK_IMPORTED_MODULE_1__.default.renderProjects();
