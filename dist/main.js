...
const DomController = (() => {
  ...
  const createCardContent = (project) => {
    ...
    todos.forEach((todo) => {
      ...
      const dueDateFormatted = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.default)(dueDate, "dd MMM");
...
const proj = _ProjectController__WEBPACK_IMPORTED_MODULE_0__.default.getProject(0);
